...
serCA=` awk -v ser=$ser '{if($2=="CA"  && $1==ser)print $3}' $gro`                                                        # cat ser 160 OG ser-CA
coordSERca=`awk -v serCA=$serCA '{if($3==serCA) print $4","$5","$6}' $gro`  # cat ser 160 CA coord to restr
